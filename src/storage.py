...
MIGRATION_SQL = [
    ...
    "ALTER TABLE articles ADD COLUMN sentiment_subject VARCHAR(20) NULL",
    "CREATE INDEX idx_articles_subject ON articles(sentiment_subject)",
